...
<form name="cart" method="post">	
		...
		<table class="table table-bordered">
			<caption style="font-size:50px;text-align:center;color:#abd07e">Bill Generation</caption>
			<thead>
				<tr>
...
<?php $cnt=$cnt+1;} ?>
		...
		<a href="javascript:void(0);" onClick="popUpWindow('payment_form.php');" title="payment" style="background-color: #abd07e;border: black;color: white;padding: 10px 80px;text-align: center;text-decoration: bold;display: inline-block;font-size: 30px;margin: 10px 2px 100px 500px;cursor: pointer;-webkit-transition-duration: 0.4s;transition-duration: 0.4s;">Payment</a>
